...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new StoryBook("SB32F", "Si kancil", 17, "Story", "Martis");
        daftarBuku[i++] = new HistoryBook("HB324", "Sejarah candi", 2, "History", "Moskov");
        daftarBuku[i++] = new TextBook("TB323", "Kucing Persia", 4, "Text", "Eudora");

        // Mengisi daftar mahasiswa
        studentList.add(0, new Student("202310370311194", "Safirah", "Teknik","Mesin"));
        studentList.add(1, new Student("202310370311195", "Ridha Safirah", "Teknik","Informatika"));
        studentList.add(2, new Student("202310370311196", "Dewi Safirah", "Teknik","Elektro"));
